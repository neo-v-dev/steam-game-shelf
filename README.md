...
- **管理ページ**: ブラウザ上のチェックボックスで表示/非表示・プレイ済みタグ・公開状態を編集可能。
...
`https://<ユーザー名>.github.io/<リポジトリ名>/admin.html` で、以下をブラウザから編集できます(JSON 編集不要)。

- ゲームごとの**表示/非表示**(チェックボックス、検索絞り込み・一括変更つき)
- ゲームごとの**プレイ済みタグ**(チップをクリックでON/OFF)
- サイトの**公開/準備中**の切り替え
